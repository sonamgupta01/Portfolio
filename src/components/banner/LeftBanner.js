...
import { FaCode, FaChartBar, FaLaptopCode, FaBrain } from "react-icons/fa";
import Media from './Media';
import resumePdf from '../../components/resume/SonamResume.pdf';
  ...
  return (
    <div className="w-full lgl:w-1/2 flex flex-col gap-12 pr-4 xl:pr-12">
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-4">
        <a
          href="#projects"
          className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-designColor to-pink-600 text-white font-medium text-base hover:from-pink-600 hover:to-designColor hover:shadow-glow-pink transition-all duration-300"
        >
          View My Projects
          <FaArrowRight
        ...
        <a
          href={resumePdf}
          download="Sonam_Gupta_Resume.pdf"
          className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-borderColorLight bg-transparent text-white font-medium text-base hover:border-designColor hover:bg-bodyColorLight hover:shadow-glow-pink-sm transition-all duration-300"
        >
          <FaDownload size={18} />
          Download Resume
        </a>
      ...
      {/* Find me on + BEST SKILL ON */}
      <div className="flex flex-col sm:flex-row items-start gap-12 lg:gap-16 pt-4">
